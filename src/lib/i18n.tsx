...
const translations = {
    en: {
        ...
        reservee: 'Reserved',
        reservationFutureErrorTitle: 'Cannot Confirm Yet',
        reservationFutureErrorDesc: 'This reservation cannot be confirmed because its rental period starts in the future. Please wait until the start date to confirm.',
        ...
        interne: 'Internal',
        voyage: 'Travel',
        retoucheArticle: 'Article Alteration',
        ...
        salaryInfo: 'Salary & Payroll',
        adminInfo: 'Administrative',
        securityInfo: 'Security & Control',
        ...
        contractsEnding: 'Contracts Ending Soon',
        lowLeaveAlert: 'Low Leave Balance',
        ...
        recentCautions: 'Recent Cautions',
        cautionDeposit: 'Deposit',
    ...
    fr: {
        ...
        semiWholesalePrice: 'Prix vente semi gros',
        ...
        reservee: 'Réservée',
        reservationFutureErrorTitle: 'Confirmation Impossible',
        reservationFutureErrorDesc: 'Cette réservation ne peut pas être confirmée car sa période de location commence dans le futur. Veuillez attendre la date de début pour confirmer.',
        noClientHistory: 'Aucun historique de service pour ce client pour le monde.',
        ...
        utilities: 'Services Publics (Eau/Élec/Internet)',
        ...
        managerName: 'Responsable Hiérarchique',
        ...
        rib: 'RIB / IBAN',
        employmentStatus: 'Statut de l\'Employé',
        active: 'Actif',
        suspended: 'Suspendu',
        terminated: 'Terminé',
        contractEndDate: 'Fin de Contrat',
        workSchedule: 'Régime Horaire',
        fixed: 'Temps Plein (Fixe)',
        shift: 'Posté (Shift)',
        partTime: 'Temps Partiel',
        leaveBalance: 'Solde de Congés (Jours)',
        ...
        salaryInfo: 'Salaire & Paiement',
        adminInfo: 'Administration',
        securityInfo: 'Sécurité & Contrôle',
        ...
        contractsEnding: 'Contrats se terminant bientôt',
        lowLeaveAlert: 'Faible solde de congés',
        ...
        recentCautions: 'Cautions récentes',
        cautionDeposit: 'Avance/Caution',
